...
public class CategoriaV3Controller {

    private final CategoriaService categoriaService;

    public CategoriaV3Controller(CategoriaService categoriaService) {
    ...
    public List<Categoria> all(@RequestParam("buscar") Optional<String> buscarOptional, @RequestParam("ordenar") Optional<String> ordenarOptional ) {
        ...
        return this.categoriaService.allByQueryFiltersByCategoriaCustomRepository(buscarOptional, ordenarOptional);
    }
